...
<div class="section kb-categories ">
    ...
    <div class="section-body shadow1">
        {if $kbcats}
    ...
    <div class="section-body shadow1">
        <div class="list-group">
            ...
            <a class="list-group-item has-icon" href="{routePath('knowledgebase-article-view', {$kbarticle.id}, {$kbarticle.urlfriendlytitle})}">
                ...
                <div class="list-group-item-body">
                    <div class="list-group-item-heading">{$kbarticle.title}{if $kbarticle.editLink} <button data-href="{$kbarticle.editLink}" class="btn btn-default btn-xs">{$LANG.edit}</button>{/if}</div>
