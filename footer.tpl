{if $loginpage eq 0 and $templatefile ne "clientregister" and $templatefile ne "password-reset-container"}<!-- login and register page without the default header and footer --></div></div>
                                        </div><!-- /.main-content -->
