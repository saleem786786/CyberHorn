...
<div class="main-body-has-sidebar main-body-has-sidebar-left">
    <div class="main-body-sidebar main-body-sidebar-secondary">
        <div class="sidebar-logo logo-container">
            <a class="logo" href="https://my.netpower.co.il/login"><img src="./templates/cyberhorn/images/netpower.png" title="NetPower" alt="NetPower"></a>
        </div>
    ...
    <div class="main-body-content">
        <div class="login">
            <div class="login-header">
                <a class="logo" href=""><img src="./templates/cyberhorn/images/netpower.png" title="NetPower" alt="NetPower"></a>
