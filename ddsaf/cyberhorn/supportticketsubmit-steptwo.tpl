                    ...
                    <div class="panel panel-default panel-form">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <button type="button" class="btn btn-primary-faded btn-block add-extra-attachement mob-m-t-2x" data-nofiletext="{$LANG.support_no_file_selected}" data-selectfiletext="{$LANG.select_file}" data-removetext="{$LANG.orderForm.remove}">
