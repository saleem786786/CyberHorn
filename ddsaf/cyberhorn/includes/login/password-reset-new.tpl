<div class="login">
    <div class="login-header">
        <a class="logo" href="{$WEB_ROOT}/index.php"><img src="./templates/cyberhorn/images/netpower.png" title="{$companyname}" alt="{$companyname}"></a>
    </div>
    <div class="login-wrapper">
        ...
        <div class="login-footer">
            <div class="text-light">{$LANG.registerintro} <a href="{$WEB_ROOT}/register.php" tabindex="5" >{$LANG.orderForm.createAccount}</a></div>
        </div>
        {/if}
    </div>
