...
$("#mobcol,#mobcols").click(function(e) {
    $(window)[0].innerWidth < 992 && ($("nav.navbar").toggleClass("mob-open"),$("nav.navbar").removeClass("navbar-collapsed"), e.stopPropagation());
    if($(window)[0].innerWidth < 992 && !$("#mobcol").hasClass("on")){
        $("#mobcol").addClass("on");
    }
...
$(window).ready(function() {
    ...
    $("nav.navbar").on("click tap", function(e) {
            ...
            e < 992 && 1 == $("nav.navbar").hasClass("mob-open") && ($("nav.navbar").removeClass("mob-open"))
        }),
