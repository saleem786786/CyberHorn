    ...
    {/if}
    {if $announcements}
        <div class="announcements-list list-group list-group-lg shadow1">
        {foreach from=$announcements item=announcement}
            <div class="list-group-item list-group-item-link" data-href="{routePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)}">
                <span class="announcement-date"><i class="fa fa-calendar"></i>{$carbon->createFromTimestamp($announcement.timestamp)->format('jS M Y')}</span>
                ...
                <div class="list-group-item-footer">
                    ...
                    {if $announcement.editLink}
                        <a data-href="{$announcement.editLink}"  class="ml-5 btn btn-primary-faded btn-sm linkgoto">
                            {$LANG.edit}
                        </a>
                    {/if}
