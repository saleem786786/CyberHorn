    <form method="post" action="{$smarty.server.PHP_SELF}?action=bulkdomain">
        ...
        {if $update eq "nameservers"}
            <div class="section">
                <div class="section-body">
                    ...
                    <ul class="list-group list-group-bordered shadow1">
            ...
            <div class="section">
                <div class="section-body">
                    <div class="panel-group panel-group-condensed nsmanagements" data-inputs-container>
                        <div class="panel panel-check {if $defaultns}checked{/if}" data-virtual-input>
                            <div class="panel-heading check">
                                <label>
                                    <input type="radio" class="icheck-control " name="nschoice" value="default" id="nschoicedefault" {if $defaultns} checked{/if} />
                        ...
                        <div class="panel panel-check {if !$defaultns} checked{/if}" data-virtual-input>
                            <div class="panel-heading check">
                                <label>
                                    <input type="radio" class="icheck-control" name="nschoice" value="custom" id="nschoicecustom"{if !$defaultns} checked{/if} />
                                    <div class="check-content">
        ...
        <div class="autorenew shadow1 p-20">
            <div class="section">
                {if $save}
            ...
            <div class="form-actions">
                <button type="submit" name="enable" value="{$LANG.domainsautorenewenable}" class="btn btn-primary">
                    ...
                    <span class="hidden-sm hidden-md hidden-lg">{$LANG.enable}</span>
                </button>
        ...
        <div class="reglock shadow1 p-20">
            <div class="section">
                {if $save}
                    {if $errors}
                    <div class="alert alert-danger">
...
<script>
    jQuery(document).ready(function(){
        jQuery('#nschoicedefault').on('ifChecked', function () {
            jQuery(".nsmanagements").find("[data-input-collapse]").removeClass("show").addClass("hide");
        });
        jQuery('#nschoicecustom').on('ifChecked', function () {
            jQuery(".nsmanagements").find("[data-input-collapse]").removeClass("hide").addClass("show");
        });
    });
