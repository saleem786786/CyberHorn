    ...
    <div class="main-body-content">
         ...
         {include file="$template/includes/login/register-form.tpl" showLanguageChooser=true showLogo=true}
            ...
            <div class="login-footer">
                <div class="text-center text-light">{$LANG.generals.alreadyregistredwithus} <a href="{$WEB_ROOT}/login">{$LANG.generals.login}</a> </div>
            </div>
        </div>
                                <div class="login-language dropdown dropup language" data-language-select="">
                <span> {$LANG.generals.currentlang}:&nbsp;</span>
                <a class="dropdown-toggle"  href="{$WEB_ROOT}/register.php?language={$LANG.generals.language_lable}">
