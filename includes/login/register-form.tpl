...
<link href="{$WEB_ROOT}/templates/{$template}/css/theme-rtl.css" rel="stylesheet">
{/if}
...
{else}
    ...
    <script>
        ...
        window.langPasswordTooShort = "{$LANG.login.at_least_pass}";
    </script>
    ...
    <form method="post" class="" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback" id="newPassword1">
                        <div class="password-content password-content-top password-content-group">
                            ...
                            <span class="text-small text-lighter password-content-text"><span id="passwordStrengthTextLabel">{$LANG.loginat_least_pass}</span><i data-toggle="tooltip" title="{$LANG.passwordtips}" data-html="true" data-trigger="click" class="ls ls-info-circle m-l-1x"></i></span>
                        </div>
        ...
        {if $showMarketingEmailOptIn}
            <div class="section section-sm">
                <div class="section-header">
                    ...
                    <p class="section-desc">{$LANG.generals.marketingEmailOptInMessage}</p>
                </div>
                <div class="panel panel-switch m-w-xs">
                    <div class="panel-body">
                        <span class="switch-label">{$LANG.generals.receive_emails}: </span>
        ...
        <div class="form-actions">
            <button class="btn btn-lg btn-primary btn-block {$captcha->getButtonClass($captchaForm)}" type="submit">{$LANG.clientregistertitle}</button>
        </div>
    </form>
    {/if}
{/if}
